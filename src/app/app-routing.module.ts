...
const routes: Routes = [
  ...
  { path: 'lista/cadastro/:id', loadChildren: './lista/cadastro/cadastro.module#CadastroPageModule' },
  ...
  { path: 'produto/cadastro/:id', loadChildren: './produto/cadastro/cadastro.module#CadastroPageModule' },
